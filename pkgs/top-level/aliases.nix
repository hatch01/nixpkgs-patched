...
mapAliases {
  ...
  open-stage-control = throw "'open-stage-control' has been removed due to being broken for more than a year consider using open-stage-control-headless instead; see RFC 180"; # Added 2026-05-04
