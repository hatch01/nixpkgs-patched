...
- The `mautrix-telegram` package has been upgraded to the new bridgev2 implementation of Mautrix bridges. This is not a drop-in replacement and will need manual reconfiguration to set up. Refer to [the official release announcement](https://mau.fi/blog/2026-04-mautrix-release/). The old Python bridge has been dropped from nixpkgs as it has not been maintained for a while.
